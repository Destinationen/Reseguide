...
class LoadTimeTableRoute_Mon2Sat2Data extends AbstractFixture implements OrderedFixtureInterface
{
    public function load(ObjectManager $manager)
    {
        ...
        $route_9a->setTitle('Linje 8');
        $ttr_9a_departure = new datetime();
        $ttr_9a_departure->settime(16,25,0);
        ...
        $route_33a->setTitle('Linje 9');
        $ttr_33a_departure = new datetime();
        $ttr_33a_departure->settime(14,45,0);
        $route_33a->setDeparture($ttr_33_departure);
