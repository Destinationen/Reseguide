...
class LoadTimeTableRoute_SunExceptions2Data extends AbstractFixture implements OrderedFixtureInterface
{
    public function load(ObjectManager $manager)
    {
        ...
        $route_1->addTrips($ttt[4]);

        // Funäsdalsberget
        $route_2 = new TimeTableRoute();
        $route_2->setRouteorder(35);
        ...
        // Funäsdalens Bussplan
        $route_A = new TimeTableRoute();
        $route_A->setRouteorder(50);
        $route_A->setTitle('Funäsdalslinjen');
        $ttr_A_departure = new datetime();
        $ttr_A_departure->settime(16,30,0);
        $route_A->setDeparture($ttr_A_departure);
        $route_A->addStops($stops[0]);
        $route_A->addTrips($ttt[4]);
        $route_A->setEndstation(true);
